  ...
  return (
    <section aria-labelledby="rockport-heading">
      ...
      <p className="text-sm text-muted-foreground mb-5">
        Kline et al. (1987) · ACSM 12th Ed. norms. <span className="font-semibold">Outdoor field test.</span>
      </p>
        ...
        >
          ...
          <div>
            ...
            <p className="text-[11px] text-destructive font-semibold mt-0.5">
              KNYL {weather?.tempF ?? "—"}°F exceeds {THERMAL_REDLINE_F}°F threshold. Defer outdoor 1-mile walk.
            </p>
          </div>
        </div>
      )}
